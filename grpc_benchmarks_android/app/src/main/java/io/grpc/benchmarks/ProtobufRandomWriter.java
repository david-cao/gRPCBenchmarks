...
//
//    public static Object generateRandomData(Class clazz) throws Exception {
//        Object o = clazz.newInstance();
//        Map<String, Class> declaredClasses = new HashMap<>();
//
...
//            // assume the field is a property to be written if public and not final
//            if (Modifier.isPublic(f.getModifiers()) && !Modifier.isFinal(f.getModifiers())) {
//                writeRandomScalar(o, f);
//                System.out.println("Field: " + f + ", value: " + f.get(o));
//            }
//            // assume it's an enum value
//            if (Modifier.isFinal(f.getModifiers())) {
//                System.out.println("Final: " + f + f.isSynthetic());
////                enumValues.add(f);
//            }
//        }
//
...
//    }
//
//    private static void writeRandomScalar(Object o, Field f)
//            throws IllegalAccessException, IllegalArgumentException
//    {
//        // Lots of if elses, since we can't use switches :(
//        Random r = new Random();
//        if (f.getType().equals(int.class)) {
//            f.setInt(o, r.nextInt());
//        } else if (f.getType().equals(float.class)) {
//            f.setFloat(o, r.nextFloat());
//        } else if (f.getType().equals(double.class)) {
//            f.setDouble(o, r.nextDouble());
//        } else if (f.getType().equals(long.class)) {
//            f.setLong(o, r.nextLong());
//        } else if (f.getType().equals(boolean.class)) {
//            f.setBoolean(o, r.nextBoolean());
//        } else if (f.getType().equals(String.class)) {
//            int length = r.nextInt(16);
//            char s[] = new char[length];
//            for (int i = 0; i < length; ++i) {
//                // generate a random ascii character that isn't a
//                s[i] = (char)(r.nextInt(95) + 32);
//            }
//            f.set(o, new String(s));
//        } else if (f.getType().equals(ByteString.class)) {
//            int length = r.nextInt(16);
//            byte b[] = new byte[length];
//            r.nextBytes(b);
//            f.set(o, ByteString.copyFrom(b));
//        } else {
//            // Possibly a nested class, enum, etc
